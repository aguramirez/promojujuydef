...
import { MapPin, Calendar, ExternalLink, Ticket, Eye } from "lucide-react";
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {events.map((event) => {
          ...
          return (
            <div
              key={event.id}
              className="bg-white dark:bg-neutral-900 rounded-3xl overflow-hidden shadow-lg border border-neutral-100 dark:border-neutral-800 flex flex-col transition-transform hover:-translate-y-1 hover:shadow-xl group cursor-pointer"
            ...
            >
              ...
              <div className="p-5 sm:p-6 flex flex-col flex-1">
                ...
                <div className="flex sm:hidden items-center justify-center gap-1 text-[10px] text-neutral-400 mt-2">
