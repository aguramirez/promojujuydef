      ...
      <div className="relative z-10 bg-white dark:bg-neutral-900 w-full max-w-lg rounded-t-3xl sm:rounded-3xl shadow-2xl overflow-hidden max-h-[92dvh] flex flex-col animate-slide-up">
        ...
        <div className="p-6 overflow-y-auto flex flex-col gap-4 flex-1">
          ...
          <div className="flex flex-col gap-3 mt-2">
            ...
            {(() => {
              const instagramUrl = promo.instagramPostUrl || (promo.ctaUrl?.includes("instagram.com") ? promo.ctaUrl : null);
            ...
            {/* Other Link / Website (If distinct from Instagram) */}
            {(() => {
              const hasExternalLink = promo.ctaUrl && 
                promo.ctaUrl !== "#" && 
                !promo.ctaUrl.includes("instagram.com") && 
                promo.ctaUrl !== promo.instagramPostUrl &&
                (promo.ctaUrl.startsWith("http://") || promo.ctaUrl.startsWith("https://"));
